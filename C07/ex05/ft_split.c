...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/31 18:14:27 by mcarnere          #+#    #+#             */
/*   Updated: 2023/08/31 18:15:05 by mcarnere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    // Iterar a través de las palabras y mostrarlas
    ...
    free(result); // Liberar la memoria del array de palabras
